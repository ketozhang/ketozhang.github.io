---
title: "An Astronomer's Scribble (2) - Understanding the Sigmas in the Hubble Discrepancy"
...
Though it may be obvious from the equation, to explain why it's in units of sigma and why we can treat it the same way as $N$-sigma signifance (i.e., with arguments from hypothesis test), you need to look at what discrepancy tells you other than this equation.
...
> *A little caveat, we only care about the absolute value of the z-score which ignores how we defined $\Delta$ (e.g., should it be experiment A minus B or B minu A).

<!-- ### Misconception: Discrepency is Relative
